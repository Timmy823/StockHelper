...
public class TWSEService {
    ...
    public JSONObject  getStockRealtimeTradeInfo() {
        try{
            ...
            return StockRealtimeTradeInfoDataParsing(all_lines);  
        }catch(IOException io){
            return responseError(io.toString());
        }
    }

    public JSONObject StockRealtimeTradeInfoDataParsing(String all_lines){
        ...
        try{
            ...
            return realtime_info.size()!= 0 ? responseStockRealtimeTradeInfoSuccess(allstockArray) : responseError("網頁解析錯誤");
        }catch(IOException io){
            return responseError(io.toString());
        }
    }

    public JSONObject responseStockRealtimeTradeInfoSuccess(JSONArray allstockArray){
