...
public class StockController {
    ...
    @GetMapping("/stock/getIIOTCStockTradeInfo")
    @CrossOrigin(origins = "*", allowedHeaders = "*")
    public JSONObject getInstitutionalInvestorsOTCStockTradeInfo(StockService stock, 
        ...
        String stockUrl = "https://www.tpex.org.tw/web/stock/3insti/";
        try {
            stock = new StockService(stockUrl, stringRedisTemplate);
            return stock.getInstitutionalInvestorsOTCStockTradeInfo(stock_id, specific_date);
