...
public class MemberService {
    ...
    public JSONObject getMemberInfo(GetMemberInfoParam data) {
        ...
        if(member == null) {
            return responseGetMemberInfoSuccess("error", member_map, "會員帳號或密碼錯誤");
        }
        ...
        return responseGetMemberInfoSuccess("OK", member_map,"");
    }

    public JSONObject responseGetMemberInfoSuccess(String create_status, HashMap<String, String> member_map, String create_message){
